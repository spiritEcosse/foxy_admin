import {TextInput, DateTimeInput, required, ReferenceInput, SelectInput, NumberInput} from 'react-admin';
...
export const ShippingRateEditDetails = () => {
    return (
        <Grid container columnSpacing={2}>
            ...
            <Grid item xs={12} sm={4}>
                <NumberInput source="delivery_days_min"  validate={[required(), validatePositive]}/>
            </Grid>
            <Grid item xs={12} sm={4}>
                <NumberInput source="delivery_days_max"  validate={[required(), validatePositive]}/>
            </Grid>
            <Grid item xs={12} sm={4}>
